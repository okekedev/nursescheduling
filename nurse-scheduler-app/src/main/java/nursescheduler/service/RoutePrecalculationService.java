    ...
    public void precalculateRoutes() {
        try {
            ...
            for (Map<String, Object> worker : workers) {
                ...
                String workerName = worker.get("firstName") + " " + worker.get("lastName");
                ...
                if (nurseCoords == null || !nurseCoords.containsKey("latitude") || !nurseCoords.containsKey("longitude")) {
                    nursesMissingCoords.add("Worker ID: " + workerId + ", Name: " + workerName);
                    continue; // Skip this worker if coordinates are missing
                }
                ...
                for (Map<String, Object> patient : assignedPatients) {
                    ...
                    if (patientCoords != null && patientCoords.containsKey("latitude") && patientCoords.containsKey("longitude")) {
